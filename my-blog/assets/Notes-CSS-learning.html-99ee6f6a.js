import{_ as i,p as r,q as c,s as a,R as n,t,Y as e,n as l}from"./framework-e1bed10d.js";const o={},p=e(`<h1 id="「初学笔记」css" tabindex="-1"><a class="header-anchor" href="#「初学笔记」css" aria-hidden="true">#</a> 「初学笔记」CSS</h1><h2 id="字体" tabindex="-1"><a class="header-anchor" href="#字体" aria-hidden="true">#</a> 字体</h2><p>字号尽量用偶数字号，奇数字号有可能出问题<br> 字体名含空格，则选用该字体时需要加引号</p><h2 id="链接伪类选择器-主要针对a标签" tabindex="-1"><a class="header-anchor" href="#链接伪类选择器-主要针对a标签" aria-hidden="true">#</a> 链接伪类选择器，主要针对a标签</h2><pre><code>link：未访问的链接
visited：已访问的链接
hover：鼠标移动到链接上
active：鼠标点击但未松开时的状态
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="bfc" tabindex="-1"><a class="header-anchor" href="#bfc" aria-hidden="true">#</a> BFC</h2>`,33),d=a("br",null,null,-1),u={href:"https://zhuanlan.zhihu.com/p/25321647",target:"_blank",rel:"noopener noreferrer"},h=e(`<p>盒子内部布局不受外界影响</p><h3 id="如何触发bfc" tabindex="-1"><a class="header-anchor" href="#如何触发bfc" aria-hidden="true">#</a> 如何触发BFC</h3><ul><li>Html</li><li>float不为none</li><li>position的值不为relative和static</li><li>overflow的值为auto,scroll或hidden</li><li>display的值为table-cell, table-caption, inline-block中的任何一个</li></ul><h3 id="作用" tabindex="-1"><a class="header-anchor" href="#作用" aria-hidden="true">#</a> 作用</h3><ul><li>阻止高度塌陷</li><li>外边距合并：同属一个BFC的相邻元素会发生外边距（margin）重叠</li><li>阻止元素被浮动元素覆盖，可用来实现两列布局</li></ul><h2 id="清除浮动的影响" tabindex="-1"><a class="header-anchor" href="#清除浮动的影响" aria-hidden="true">#</a> 清除浮动的影响</h2><pre><code>clear:both		在浮动的盒子后面添加一个空盒子，并给样式添加该属性
...
</code></pre>`,21);function f(g,x){const s=l("ExternalLinkIcon");return r(),c("div",null,[p,a("blockquote",null,[a("p",null,[n("Block Formatting Contexts（块级格式化上下文)"),d,a("a",u,[n("10 分钟理解 BFC 原理"),t(s)])])]),h,a("blockquote",null,[a("p",null,[a("a",v,[n("更多内容参考阮大文章"),t(s)])])]),b,a("blockquote",null,[a("p",null,[a("a",m,[n("更多内容参考阮大文章"),t(s)])])]),k])}const y=i(o,[["render",f],["__file","Notes-CSS-learning.html.vue"]]);export{y as default};
