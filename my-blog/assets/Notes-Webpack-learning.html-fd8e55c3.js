import{_ as n,p as s,q as a,Y as e}from"./framework-e1bed10d.js";const p={},t=e(`<h1 id="「初学笔记」webpack" tabindex="-1"><a class="header-anchor" href="#「初学笔记」webpack" aria-hidden="true">#</a> 「初学笔记」Webpack</h1><blockquote><p>功能：将ES6等代码编译成浏览器能识别的代码 注意：webpack能处理js/json，但不能处理css/img等</p></blockquote><h2 id="一、开始" tabindex="-1"><a class="header-anchor" href="#一、开始" aria-hidden="true">#</a> 一、开始</h2><p><code>npm install webpack webpack-cli --save-dev</code></p><h2 id="二、编译环境" tabindex="-1"><a class="header-anchor" href="#二、编译环境" aria-hidden="true">#</a> 二、编译环境</h2><p>开发环境打包</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>webpack ./src/index.js -o ./build --mode=development
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,133),o=[t];function l(i,c){return s(),a("div",null,o)}const u=n(p,[["render",l],["__file","Notes-Webpack-learning.html.vue"]]);export{u as default};
