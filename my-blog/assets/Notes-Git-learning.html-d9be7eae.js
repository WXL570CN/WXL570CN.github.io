import{_ as i,p as l,q as t,s as n,R as a,t as s,Y as d,n as c}from"./framework-e1bed10d.js";const r={},o=n("h1",{id:"「初学笔记」git",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#「初学笔记」git","aria-hidden":"true"},"#"),a(" 「初学笔记」Git")],-1),p=n("h2",{id:"_1、教程",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1、教程","aria-hidden":"true"},"#"),a(" 1、教程")],-1),u={href:"https://www.liaoxuefeng.com/wiki/896043488029600",target:"_blank",rel:"noopener noreferrer"},h={href:"https://learngitbranching.js.org/?locale=zh_CN",target:"_blank",rel:"noopener noreferrer"},v=d(`<h2 id="_2、配置用户信息" tabindex="-1"><a class="header-anchor" href="#_2、配置用户信息" aria-hidden="true">#</a> 2、配置用户信息</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 声明用户名</span>
